...
class Product:
    ...
    def __init__(self, name, nutriscore=None, categories=None,
                 url=None, brands=None, stores=None, id=None):
        ...
        Use of a condition to call methods allowing the creation
        of list of stores, brands and categories object"""
    ...
    def split_cat(self):
        ...
        """"split string of characters in liste
        and call class category to creat object category"""
    ...
    def split_brands(self):
        ...
        """"split string of characters in liste
        and call class category to creat object brand"""
    ...
    def split_stores(self):
        ...
        """"split string of characters in liste
        and call class category to creat object store """
